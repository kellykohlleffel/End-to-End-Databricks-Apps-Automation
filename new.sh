...
EXISTING_WAREHOUSE_NAME="ts-databricks-azure-sql-serverless-demo"
WAREHOUSE_KEY="sql-warehouse"
WAREHOUSE_PERMISSION="CAN_USE"

# Secret (from your existing secret scope)  
EXISTING_SECRET_SCOPE="databricks-app-secrets"
EXISTING_SECRET_KEY="databricks-token-secret"
...
DEFAULT_UC_CATALOG="my-unity-catalog-name"
DEFAULT_UC_SCHEMA="my-schema-name" 
DEFAULT_UC_TABLE="my_table_name"
